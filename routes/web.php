...
Route::middleware('legacy.super')->group(function () {
    Route::any('/admin/products/{id}/delete', [AdminController::class, 'deleteProduct']);
...
Route::middleware('legacy.orders')->group(function () {
    ...
    Route::any('/admin/export', [AdminController::class, 'exportOrders']);
    Route::any('/admin/orders/{id}/status', [AdminController::class, 'updateOrderStatus']);
...
Route::middleware('throttle:api')->group(function () {
    Route::any('/api/orders', [OrderController::class, 'createOrder']);
});
