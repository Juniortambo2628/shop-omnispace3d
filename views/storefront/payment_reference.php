...
<?php include __DIR__ . '/_head.php'; ?>
    <style>
        ...
        .section { background: #fff; border-radius: 12px; box-shadow: 0 1px 6px rgba(0,0,0,0.06); padding: 28px; margin-bottom: 20px; }
        .section h2 { font-size: 18px; font-weight: 700; color: #1a1a1a; margin-bottom: 6px; }
        .section .subtitle { font-size: 13px; color: #666; margin-bottom: 20px; line-height: 1.6; }
        label { display: block; font-size: 13px; font-weight: 600; color: #555; margin-bottom: 6px; }
        input, select { width: 100%; padding: 12px 14px; border: 1px solid #ddd; border-radius: 6px; font-size: 14px; font-family: inherit; margin-bottom: 18px; transition: border 0.2s; }
        input:focus, select:focus { outline: none; border-color: #0A9696; box-shadow: 0 0 0 3px rgba(10,150,150,0.1); }
