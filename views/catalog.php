...
<?php include __DIR__ . '/storefront/_head.php'; ?>
    <style>
        ...
        .event-hero { background: #fff; border-bottom: 3px solid var(--brand-teal); padding: 32px 40px; display: flex; align-items: center; gap: 40px; animation: catalog-hero-in 0.55s cubic-bezier(0.22, 1, 0.36, 1) both; }
        ...
        .event-hero-divider { width: 2px; height: 120px; background: var(--brand-teal-pale); flex-shrink: 0; }
        .event-hero-info { flex: 1; animation: catalog-hero-text-in 0.55s cubic-bezier(0.22, 1, 0.36, 1) 0.14s both; }
        .event-hero-info h2 { font-size: 22px; font-weight: 700; color: var(--brand-teal); margin-bottom: 6px; line-height: 1.25; }
        ...
        .event-hero-info .hero-tagline { display: inline-block; background: var(--brand-teal-pale); color: var(--brand-teal); font-size: 12px; font-weight: 600; padding: 5px 14px; border-radius: 20px; }

        .info-bar { background: var(--brand-teal-pale); padding: 10px 28px; font-size: 12px; color: #555; display: flex; gap: 24px; flex-wrap: wrap; border-bottom: 1px solid #b8e0df; animation: catalog-fade-up 0.45s ease 0.2s both; }
        .info-bar span { display: flex; align-items: center; gap: 6px; }

        .deadlines { border-bottom: 2px solid var(--brand-teal); }
        .deadlines-toggle { padding: 12px 28px; cursor: pointer; display: flex; justify-content: space-between; align-items: center; background: #eaf6f6; font-size: 14px; font-weight: 600; color: var(--brand-teal); user-select: none; }
        ...
        .deadlines-table th { background: var(--brand-teal); color: #fff; padding: 10px 16px; text-align: left; font-weight: 600; }
        ...
        .cat-list { list-style: none; overflow-y: auto; overflow-x: hidden; flex: 1; scrollbar-width: thin; scrollbar-color: var(--brand-teal) #f0f0f0; margin: 0; padding: 0; }
        .cat-list::-webkit-scrollbar { width: 5px; }
        .cat-list::-webkit-scrollbar-track { background: #f0f0f0; border-radius: 0 0 10px 0; }
        .cat-list::-webkit-scrollbar-thumb { background: var(--brand-teal); border-radius: 10px; }
        ...
        .cat-item.active { background: var(--brand-teal-pale); border-left-color: var(--brand-teal); font-weight: 600; color: var(--brand-teal); transform: translateX(2px); }
        .cat-item.scroll-active { background: var(--brand-teal-pale); border-left-color: var(--brand-teal); font-weight: 600; color: var(--brand-teal); transform: translateX(2px); }
        .cat-item.scroll-active .cat-count { background: var(--brand-teal); color: #fff; }
        ...
        .cat-item.active .cat-count { background: var(--brand-teal); color: #fff; }
        ...
        .search-box input:focus { outline: none; border-color: var(--brand-teal); box-shadow: 0 0 0 3px rgba(10,150,150,0.12); transform: translateY(-1px); }
        .search-icon { position: absolute; left: 14px; top: 50%; transform: translateY(-50%); font-size: 18px; color: #aaa; transition: color 0.2s; }
        .search-box:focus-within .search-icon { color: var(--brand-teal); }
        ...
        .grid-sentinel__spinner { width: 28px; height: 28px; border: 3px solid var(--brand-teal-pale); border-top-color: var(--brand-teal); border-radius: 50%; animation: catalog-spin 0.75s linear infinite; }
        ...
        .card-img-placeholder { width: 100%; height: 140px; background: linear-gradient(135deg, var(--brand-teal-pale) 0%, #f0fdfd 100%); display: flex; align-items: center; justify-content: center; font-size: 36px; color: #b2dede; }
        .card-body { padding: 16px 18px; display: flex; flex-direction: column; flex: 1; }
        .card-code { font-size: 11px; color: var(--brand-teal); font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 6px; }
        ...
        .color-chip:hover, .color-chip.selected { border-color: var(--brand-teal); background: var(--brand-teal-pale); color: var(--brand-teal); font-weight: 600; }
        .card-bottom { margin-top: auto; padding-top: 12px; border-top: 1px solid #f0f0f0; }
        .card-price { font-size: 20px; font-weight: 700; color: var(--brand-teal); margin-bottom: 4px; }
        ...
        .add-btn { flex: 1; padding: 8px 16px; background: var(--brand-teal); color: #fff; border: none; border-radius: 6px; cursor: pointer; font-size: 13px; font-weight: 600; font-family: inherit; transition: background 0.2s, transform 0.15s; }
        .add-btn:hover { background: var(--brand-teal-dark); transform: translateY(-1px); }
        ...
        .drawer.open { right: 0; }
        .drawer-head { background: var(--brand-teal); color: #fff; padding: 16px 20px; display: flex; justify-content: space-between; align-items: center; font-weight: 700; font-size: 16px; }
        ...
        .di-price { font-weight: 700; color: var(--brand-teal); font-size: 14px; }
        ...
        .checkout-btn { width: 100%; padding: 14px; background: var(--brand-teal); color: #fff; border: none; border-radius: 8px; cursor: pointer; font-size: 15px; font-weight: 700; font-family: inherit; margin-top: 12px; transition: background 0.2s; }
        .checkout-btn:hover { background: var(--brand-teal-dark); }
        ...
        .back-to-top:hover { background: var(--brand-teal-dark); transform: translateY(0) scale(1.04); }
        ...
        .vat-note { font-size: 11px; color: var(--brand-teal); background: var(--brand-teal-pale); padding: 8px 14px; border-radius: 6px; margin-bottom: 16px; text-align: center; font-weight: 500; }
        ...
        @media (max-width: 768px) {
            ...
            .cat-item.active { border-bottom-color: var(--brand-teal); border-left: none; }
            .cat-item.scroll-active { border-bottom-color: var(--brand-teal); border-left: none; }
